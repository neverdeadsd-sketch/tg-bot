...
(function () {
  ...
  var CONFIG = {
    ...
    /* Оплата на сайте.
     *
     * Сейчас сайт — статика без сервера (GitHub Pages), а деньги
     * принимает бот: там способы оплаты уже подключены. Поэтому обе
     * строки пустые, ссылка «оплатить на сайте» не показывается,
     * а checkout.html, если на него всё же зайти, отправит в бота.
     *
     * Появится сервис из папки checkout/ — впишите сюда:
     *   checkout:    '/checkout.html'
     *   checkoutApi: '/api'   (или полный адрес, если API на другом домене —
     *                          тогда origin сайта должен быть в PUBLIC_URL
     *                          сервиса, иначе CORS его не пропустит) */
    checkout: '',
    checkoutApi: '',
